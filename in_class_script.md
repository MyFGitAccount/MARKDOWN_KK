...
"Good morning everyone. I'm Xavier, joined by my group members Kwok Ho Yin and Young Ho Tim. Today we're presenting the final outcomes and testing results for our Educational Facilitation System, or EFS Platform, developed for CCIT4080 Knowledge Product Development.

Our platform is fully deployed and live at hku.wiki, with all four core modules implemented, tested, and validated with real users."
...
"Let me give you a quick snapshot of what we've achieved.

First, we have a fully deployed platform with four complete modules: Timetable Planner, Group Formation, Questionnaire Exchange, and Materials Repository.

Our user survey with 51 respondents showed 96% rated the platform as good or excellent overall.

Performance testing with k6 under 200 concurrent users resulted in a 0% failure rate across 5,000 requests, with average response time of just 15 milliseconds and p95 at 29 milliseconds.

All four core modules are production-ready and functioning as designed."

---

## SLIDE 3: Four Core Modules

*[Click to next slide]*

**Speech:**

"Let me briefly walk you through each module.

The Timetable Planner allows drag-and-drop scheduling with clash detection. Users can export their timetable as a PNG using html2canvas, which has been calibrated for accurate output.

Group Formation enables profile-based matching. When users send invitations, email notifications are triggered, and once a match is accepted, real-time chat with polling is activated. We implemented 3-second polling for messages and 5-second for group updates as a lightweight alternative to WebSockets.

The Questionnaire Exchange module uses a credit system. New users start with 3 credits. Filling a survey earns you 1 credit; posting a survey costs 1 credit. You can have unlimited active surveys simultaneously. Daily login gives an additional 2-credit bonus.

The Materials Repository allows administrators to upload course files using GridFS storage with download tracking for analytics.

Additionally, we've built an admin dashboard, implemented JWT authentication, and added responsive breakpoints at 768 and 1024 pixels for mobile and tablet devices."

---

## SLIDE 4: Performance Testing - k6 Load Test
...
These numbers demonstrate that our platform can handle significant concurrent user load comfortably within acceptable performance thresholds."

---

## SLIDE 5: Lighthouse Performance (Mobile)
...
Our performance score came in at 75. We achieved a perfect 100 on Best Practices, 96 on Accessibility — which is excellent — and 90 on SEO.
...
Qualitative feedback included comments like 'faster, efficient', 'specialised for HKU SPACE', and 'convenient, powerful'. The most valued feature was the Timetable Planner at 26.5% of responses. Users recommended a starting credit balance of 3.8 on average — our current system uses 3 credits, so we may adjust this in the next iteration."

---

## SLIDE 7: Problem Validation
...
## SLIDE 10: Credit System Deep Dive
...
New users receive 3 credits upon admin approval. You earn 1 credit for filling someone else's survey, plus a 2-credit daily login bonus. Posting your own questionnaire costs 1 credit.
...
Our survey rated fairness at 4.38 out of 5. Users recommended a starting balance of 3.8 credits on average. Since we currently use 3, we may adjust this in the next iteration based on this feedback."
...
Thank you for your attention. We welcome any feedback or questions."
...
Be ready to answer these likely questions:
...
| Why is LCP at 3.6s? | Largest element is the login card text. Further optimization could preload critical CSS or inline styles. Currently acceptable for educational tool. |
